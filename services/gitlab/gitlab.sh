...
source "$_SAAS_GITLAB_DIR/lib/postgres_integration.sh"
...
Targets:
  ...
  postgres  Apply, into this GitLab cluster, the datastore Secret
            'saas postgres integrate gitlab' generated on the postgres
            side, see 'saas gitlab integrate postgres --help'
EOF
}
...
_saas_gitlab_integrate() {
    ...
    case "$target" in
        ...
        postgres)      _saas_gitlab_integrate_postgres "$@" ;;
        ""|-h|--help|help)
            _saas_gitlab_integrate_help
            ;;
        *)
...
Subcommands:
  ...
  integrate     Apply manifests generated by another service (Vault,
                MinIO, or Postgres), see 'saas gitlab integrate --help'

Examples:
  saas gitlab install
  saas gitlab install --help
  saas gitlab install --object-storage external   # after 'saas gitlab integrate minio'
  saas gitlab install --database external         # after 'saas gitlab integrate postgres'
  saas gitlab status
